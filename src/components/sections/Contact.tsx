...
export function Contact() {
  ...
  return (
    <section id="contato" className="py-20 bg-gray-50" aria-labelledby="contato-title">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          ...
          <div className="flex flex-col gap-4">
            <a
              ...
              aria-label="Falar no WhatsApp - (15) 99771-9681 (abre em nova aba)"
            >
            ...
            <a
              ...
              className="bg-white border border-gray-100 rounded-2xl p-4 flex items-center gap-4 hover:border-blue-200 transition-colors"
              aria-label={`Enviar e-mail para ${SITE_CONFIG.email}`}
            >
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 border border-gray-100 shadow-sm">
            <h3 id="contato-title" className="text-xl font-bold text-blue-800 mb-6 flex items-center gap-2">
              <span className="w-1 h-6 bg-blue-700 rounded-full inline-block" aria-hidden="true" />
              ...
              <>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <a
                    ...
                    aria-label="Abrir WhatsApp direto (abre em nova aba)"
                  >
